...
public class d {
    ...
    private int[] countLetters(String message) {
        /**
         * Input: String - message: count letter inside a string Output: int[]: array of
         * int contains the letter counting/frequency
         */
    ...
    private int maxIndex(int[] vals) {
        /**
         * Input: int[] - vals: array of int which used to find index with max value
         * Output: int: the index with max value in vals
         */
    ...
    private int getKey(String s) {
        /**
         * Input: String - s Output: int: key to decrypted s using most frequency letter
         * method
         */
        ...
        // 26 - (4 - maxDex) loop around to found the key; how much it shift to the
        // right
        if (maxDex < 4)
            key = 26 - (4 - maxDex);
        return key;
